...
namespace MiniHttpServer.Frimework.Settings
{
    public class JsonEntity
    {
        ...
        public JsonEntity(string loginUri,string olaraUri, string searcherPath, string chatGPTPath, string searcherUri,string chatGPTUri, string domain, string port, string conectionstring)
        {
            LoginUri = loginUri;
            OlaraUri = olaraUri;
